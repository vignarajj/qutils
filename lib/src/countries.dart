...
class QCountries {
  ...
  static QCountry? byPhoneCode(String phoneCode) {
    try {
      final cleanPhoneCode = phoneCode.startsWith('+')
          ? phoneCode
          : '+$phoneCode';
  ...
  /// Get all ISO2 codes
  static List<String> get iso2Codes =>
      all.map((country) => country.iso2).toList();

  /// Get all ISO3 codes
  static List<String> get iso3Codes =>
      all.map((country) => country.iso3).toList();

  /// Get all phone codes
  static List<String> get phoneCodes =>
      all.map((country) => country.phoneCode).toList();

  /// Get all country emojis
  static List<String> get emojis =>
      all.map((country) => country.emoji).toList();
}
